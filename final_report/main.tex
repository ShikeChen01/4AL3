...
Financial trading is increasingly viewed as a sequential decision-making problem 
rather than a supervised regression task. (Zhang2020) argue that Reinforcement 
Learning (RL) offers a superior framework by bypassing explicit forecasting to 
optimize trade positions directly, thereby navigating the low signal-to-noise 
ratio of financial data. Among RL methods, Proximal Policy Optimisation (PPO) 
(Schulman2017) is particularly effective; its clipped surrogate objective stabilizes
 updates in non-stationary, noisy market environments.

Recent literature highlights the versatility of RL in quantitative finance (Sun2023). 
Studies have successfully applied Deep RL to adaptive ensemble strategies (Yang2020) 
and complex portfolio allocations involving short-selling (Huang2020). 
To capture asset inter-dependencies and dynamic market complexity, researchers 
have also introduced graph-convolutional architectures (Soleymani2021) and model-free 
frameworks (Jiang2024).

However, training requires robust reward functions that account for tail risk. 
(Zakamouline2009) demonstrate that standard mean-variance metrics often fail to 
capture higher moments like skewness and kurtosis. They propose the Generalized 
Sharpe Ratio (GSR), grounded in Expected Utility Theory, as a more reliable 
performance measure. Consequently, integrating PPO with risk-adjusted metrics 
like GSR offers a promising direction for robust trading-policy development.
...
@article{Huang2020,
  ...
  author    = {Huang, Gang and Zhou, Xin and Song, Qing},
...
@article{Jiang2024,
  ...
  author    = {Jiang, Yifan and He, Xiang and Zhang, Wei},
...
@inproceedings{Lam2023,
  ...
  author    = {Lam, Tze Siang and Verma, Abhinav and Low, Bryan Kian Hsiang and Jaillet, Patrick},
  booktitle = {Proceedings of the International Conference on Learning Representations (ICLR)},
  year      = {2023},
  url       = {https://www.mit.edu/~jaillet/general/iclr23b.pdf}
}
...
@article{Soleymani2021,
  ...
  journal   = {arXiv preprint arXiv:2105.08664},
  year      = {2021},
  url       = {https://arxiv.org/abs/2105.08664}
}
